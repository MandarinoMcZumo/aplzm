...
PORT_PREDICT = os.environ.get('PORT_PREDICT')
if PORT_REGISTRY is None:
    PORT_REGISTRY = 5001
...
ASNEF_MODEL = os.environ.get('ASNEF_MODEL')
if ASNEF_MODEL is None:
    if platform.system() == 'Windows':
        ASNEF_MODEL = 'resources\\models\\asnef_inference.pkl'
    else:
        ASNEF_MODEL = 'predict/app/resources/models/asnef_inference.pkl'
